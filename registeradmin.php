...
if (isset($_POST['register'])) {
    ...
    $queryRegister = "INSERT INTO users VALUES ('', '$nama', '$email', '$username', '$password', 'accepted', 'admin')";
 ...
 <nav class="navbar navbar-expand-lg bg-dark">
  ...
  <form action="" method="POST" class="container">
     <div class="col-md-4">
        ...
        <h1 class="my-4">
           <small>Registrasi admin online</small>
       </h1>
...
<p class="container">Kembali? <a href="admin.php">disini</a></p>
